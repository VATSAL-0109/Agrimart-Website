...
const OrderDetailsFooterIcons = () => {
  return (
    <div className="flex justify-between items-center text-[.7rem] max-[1626px]:text-[.7rem] mt-4 opacity-[.8] font-thin">
...
export default OrderDetailsFooterIcons
